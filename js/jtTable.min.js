...
var jsTable = (function () {
    ...
    jsTable.prototype.nextId = 0;

    jsTable.prototype.data = function(foo, key, action) {
    ...
    jsTable.prototype.config = function (key, value) {
    ...
    jsTable.prototype.init = function () {
        ...
        // And return bigger id, add 1 to get next id
        this.nextId = this._initData() + 1;
    ...
    jsTable.prototype._initData = function () {
        ...
        try {
            ...
            console.error('Invalid data format, must be a valid JSON')
            return maxNumber
        }

        for (var key in this._data) {
            if (this._data.hasOwnProperty(key)) {
                var id = parseInt(key.substr(2), 10)
                if (id > maxNumber) {
                    maxNumber = id;
                }
    ...
    jsTable.prototype._allow = function (action) {
    ...
    jsTable.prototype._setId = function() {
        var id = this.nextId;
        this.nextId += 1;
        return 'jt' + id;
    };

    jsTable.prototype._isNew = function(tr) {
        var result = false;
    ...
    jsTable.prototype._attachEvents = function () {
        if (this._allow('add')) {
    ...
    jsTable.prototype._toggleEmpty = function (hide) {
        utils[(Boolean(hide)) ? 'addClass' : 'removeClass'](this.emptyRow, 'jt-hidden');
    };

    jsTable.prototype._evenOddClass = function(el, index) {
        utils.addClass(el, this.config((index % 2) ? 'evenClass' : 'oddClass'));
    };

    jsTable.prototype._resetRowsClass = function() {
    ...
    jsTable.prototype._sorting = function() {
        if (!this.config('sorting')) {
            return false;
        }
    ...
    jsTable.prototype._formatContent = function(foo, label) {
    ...
    jsTable.prototype._createEditBtn = function () {
    ...
    jsTable.prototype._createDeleteBtn = function () {
        var btn = document.createElement('button');
    ...
    jsTable.prototype._createCancelEditBtn = function () {
        var btn = document.createElement('button');
    ...
    jsTable.prototype._createSaveBtn = function () {
        var btn = document.createElement('button');
    ...
    jsTable.prototype._createEditingDiv = function() {
    ...
    jsTable.prototype._createNormalDiv = function() {
        var div = document.createElement('div');
    ...
    jsTable.prototype._createOptionsCell = function (tr, pos) {
        var td = this.addCell(tr, pos);
        td.appendChild(this._createNormalDiv());
        td.appendChild(this._createEditingDiv());
    };

    jsTable.prototype._createInput = function (label, value) {
    ...
    jsTable.prototype.onKeyPress = function (ev) {
        if (ev.which === 13 || ev.charCode === 13) {
            this.onSaveRow(ev);
        }
    };

    jsTable.prototype.onAddRow = function (ev) {
        ev.preventDefault();
    ...
    jsTable.prototype.onEditRow = function (ev) {
        ev.preventDefault();
    ...
    jsTable.prototype.onDeleteRow = function (ev) {
        ev.preventDefault();
    ...
    jsTable.prototype.onCancelRow = function(ev) {
        ev.preventDefault();
    ...
    jsTable.prototype.onSaveRow = function (ev) {
        ev.preventDefault();
    ...
    jsTable.prototype.onSaveOrder = function(ev) {
        ev.preventDefault();
    ...
    jsTable.prototype._createColums = function(tr, id) {
        var isNew = this._isNew(tr);
        for (var i = 0, j = this.config('cols') - 1; i < j; i++) {
    ...
    jsTable.prototype._toggleColumns = function(tr, edit) {
    ...
    jsTable.prototype.addCell = function (tr, pos, label, html) {
    ...
    jsTable.prototype.addRow = function (id, isNew) {
    ...
    jsTable.prototype.removeRow = function (tr) {
        try {
